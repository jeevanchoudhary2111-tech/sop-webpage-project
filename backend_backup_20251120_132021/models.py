...
class SOPDefinition(BaseModel):
    ...
    name: str = Field(..., min_length=1, max_length=100, description="User-friendly name for the SOP (e.g., 'GIFT SOP')")
...
class MarkedDateResponse(BaseModel):
    ...
    marked_at: datetime
class GIFTPositionCheck(BaseModel):
    id: Optional[str] = Field(default=None, alias="_id")
    user_id: str
    username: str
    date: str  # Format: YYYY-MM-DD
    time: str  # Format: HH:MM AM/PM (e.g., "6:30 AM")
    turnover_report: Optional[float] = None
    exit_portal: Optional[float] = None
    matched: bool = False
...
class GIFTPositionCheckCreate(BaseModel):
    time: str
    turnover_report: Optional[float] = None
    exit_portal: Optional[float] = None
    matched: bool = False

class GIFTPositionCheckUpdate(BaseModel):
    turnover_report: Optional[float] = None
    exit_portal: Optional[float] = None
